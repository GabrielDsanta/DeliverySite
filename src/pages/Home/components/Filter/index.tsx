...
export function Filter() {
  ...
  return (
    <ContainerFilter>
      <select onChange={(e: SyntheticEvent<HTMLSelectElement>) => CallSetFilter(e.currentTarget.value)} name="" id="">
      ...
      <select onChange={(e: SyntheticEvent<HTMLSelectElement>) => CallSetRate(e.currentTarget.value)} name="" id="">
        <option value="" selected>
          Ordenar
        </option>
